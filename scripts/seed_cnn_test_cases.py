# scripts/seed_cnn_test_cases.py
import os
import json
import requests
import sys
...
GOLDEN_DATASET_PATH = "data/cnn_golden_dataset.json"

def main():
    """
    Seeds the database with CNN time series test cases from the golden dataset.
    """
    print(f"--- Seeding CNN Test Cases from Golden Dataset ---")
    ...
    if not os.path.exists(GOLDEN_DATASET_PATH):
        ...
        print("  python scripts/train_cnn_time_series.py")
        return
    ...
    for case in golden_cases:
        ...
        payload = {
            "test_case_name": f"CNN TS Prediction - Case {case_id}",
            "model_type": "time_series_cnn",
            "input_type": "time_series_window",
            "output_type": "temperature_prediction",
            "input_data": case['input_data'],
            "ground_truth": case['ground_truth'],
            "category": "weather_forecasting",
            "tags": ["cnn", "conv1d", "multistep", "relu", "time_series"],
    ...
    #     print("     curl -X 'POST' 'http://localhost:8000/api/v1/runs/' \")
    #     print("       -H 'Content-Type: application/json' \")
    #     print("       -d '{\"model_name\": \"cnn_model\", \"model_version\": \"1.0\", \"model_type\": \"time_series_cnn\"}'")
    #     print("\n  2. Run evaluation:")
    #     print("     python scripts/run_evaluation.py <RUN_ID>")
    #     print("\n  3. Generate report:")
    #     print("     python scripts/generate_report_time_series_v3.py <RUN_ID>")
    

    # curl -X 'POST' 'http://localhost:8000/api/v1/runs/' -H 'Content-Type: application/json' -d '{"model_name": "cnn_model", "model_version": "1.0", "model_type": "time_series_cnn"}'
    ...
    if total_created > 0:
       ...
       -d '{\"model_name\": \"cnn_model\", \"model_version\": \"1.0\", \"model_type\": \"time_series_cnn\"}'")
        print("\n  2. Run evaluation:")
        print("     python scripts/run_evaluation.py <RUN_ID>")
        print("\n  3. Generate report:")
