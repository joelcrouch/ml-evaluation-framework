# scripts/seed_rnn_test_cases.py
import os
import json
import requests
import sys
...
GOLDEN_DATASET_PATH = "data/rnn_golden_dataset.json"

def main():
    """
    Seeds the database with RNN time series test cases from the golden dataset.
    """
    print(f"--- Seeding RNN Test Cases from Golden Dataset ---")
    ...
    if not os.path.exists(GOLDEN_DATASET_PATH):
        ...
        print("  python scripts/train_rnn_time_series.py")
        return
    ...
    for case in golden_cases:
        ...
        payload = {
            "test_case_name": f"RNN TS Prediction - Case {case_id}",
            "model_type": "time_series_rnn",
            "input_type": "time_series_window",
            "output_type": "temperature_prediction",
            "input_data": case['input_data'],
            "ground_truth": case['ground_truth'],
            "category": "weather_forecasting",
            "tags": ["rnn", "lstm", "multistep", "time_series"],
    ...
    if total_created > 0:
        ...
        print("       -d '{\"model_name\": \"rnn_model\", \"model_version\": \"1.0\", \"model_type\": \"time_series_rnn\"}'")
        print("\n  2. Run evaluation:")
